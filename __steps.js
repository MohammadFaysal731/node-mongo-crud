 ...
 * 1.5 create index.js
 * 1.6 user 5 steps to create a node server
 * 
 * ---------------------
 * Create Atlas Account
 * ------------------------
 * 1.sing up with google access
 * 2.create cluster
 ...
 * ------------------------------------------------
 * Integrate sending data from client ot server
 * -----------------------------------------------------
 ...
 * 4.on clients side: set fetch with POST,headers,body
 ...
 * 4.cursor.toArray()
 * 5.return the result
 * 6.form client useEffect and display like you have done before
 * -----------------------
 * DELETE DATA FORM Client side and database
 * --------------------------
 * 
 * 
 * */ 